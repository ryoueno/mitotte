FactoryGirl.define do
  ...
  sequence(:subject) { Faker::Pokemon.location + "プロジェクト" }
  sequence(:description) { Faker::Pokemon.location + "で活躍するために必要なスキルを身につけるためのプロジェクトです。" }
  ...
  sequence(:task_status_id) { TaskStatus::all.sample.id }
